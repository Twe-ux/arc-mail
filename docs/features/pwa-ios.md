...
**On sort le titre de dessous lui : `--sous-flou`, 12 px** (10 sept.).
...
Le dégradé s'éteint donc **entre 85 et 90 pt**.

**Douze pixels, et sous les points — pas vingt-huit sur toute la coque.** La première version
descendait *l'écran entier* de 28 px : le premier élément peint étant à 59, c'était le chiffre exact
pour que même les points en sortent. Ça marchait, et ça coûtait un tiers de rangée sur chaque écran
— rendu le soir même : « ça marche mais du coup c'est pas top ». L'écart ne se met donc plus
qu'**entre l'indicateur de pages et le titre** : le titre passe la barre des 90 pt (mesuré : sa
boîte va de 75 à **87**, ses hampes à ~91), les points restent dans le dégradé. Ce sont deux
pastilles, pas du texte, et elles ont gagné du contraste pour ça (35 %).
...
sur *sa* barre et pas sur la page, l'écart n'y serait qu'un trou. **Elle ne se voit pas en
émulation**, et c'est normal : Chromium n'y est pas en `display-mode: standalone`. Pour la mesurer,
forcer `:root{--sous-flou:12px}` avec `addStyleTag`.
